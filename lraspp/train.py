...
def create_model(num_classes, pretrain=True):
    ...
    if pretrain:
        weights_dict = torch.load(r"C:\Users\12955\Desktop\change_driven SemCom\lraspp\lraspp_mobilenet_v3_large.pth", map_location='cpu')
...
def parse_args():
    ...
    parser.add_argument("--data-path", default=r"C:\Users\12955\Desktop\change_driven SemCom", help="VOCdevkit root")
